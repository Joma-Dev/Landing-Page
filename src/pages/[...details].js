				...
				<div className="question-details-area mt-3 mt-md-5">
					...
					/>
						<h1 className="video-section-header mt-2 mb-3 mb-md-4">
							About Jomma | <span style={{ fontFamily: 'Noto Sans Bengali' }}>জমা সম্পর্কে তথ্য</span>
						</h1>

						<div className='w-100' style={{height:'1px', backgroundColor:'#A5A5A7'}}></div>
