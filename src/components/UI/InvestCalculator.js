			...
			<div className="container">
				...
				<div className={`${styles.calculatorInputArea}`}>
					<div className="d-flex align-items-center mb-2 mb-lg-0">
						...
						<p
							className={`${styles.calculatorAmountInputText} ${styles.calculatorAmountInputTextMobile} mx-2 mb-0`}
						>
							I want to save
						</p>
					</div>
				...
				<div className="d-flex justify-content-center mb-3">
					{selectedOption === '0.09' && (
						<>
							<div
								...
								onClick={() => handlePageRedirect('themematic')}
							>
					...
					{selectedOption === '0.10' && (
						<div
							className={`${styles.card} p-0`}
							style={{ cursor: 'pointer' }}
							onClick={() => handlePageRedirect('stocks')}
						>
							<div className={`${styles.customCardbody} card-body`}>
								<div className="d-flex justify-content-center align-items-center flex-column">
									<Image
									...
									/>
									<p
										className={`${styles.ProductStocksTitle} ${styles.ProductStocksTitleSize}`}
									>
										Stocks
									</p>
								</div>
					...
					{selectedOption === '0.07' && (
						<div
							className={`${styles.card} p-0`}
							style={{ cursor: 'pointer' }}
							onClick={() => handlePageRedirect('saving')}
						>
							<div className={`${styles.customCardbody} card-body`}>
								<div className="d-flex justify-content-center align-items-center flex-column">
									<Image
